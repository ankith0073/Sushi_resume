...
\profilepic{sushmitha.jpg} % Profile picture

\cvname{Sushmitha} % Your name
\cvsecondname{Bangalore Nagendra}
\cvjobtitle{Business Administrator} % Job title/career

\cvdate{23 January 1996} % Date of birth
\cvaddress{Weststraße 87\newline 42119 Wuppertal}
 % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+49 17657804887} % Phone number
%\cvsite{http://en.wikipedia.org} % Personal website
\cvmail{sashasonu332@gmail.com} % Email address
...
\aboutme{Sushmitha is a talented young lady interested in public relations to enhance the Business activities. Sushmitha's such familiarity comes from the history of maintaining, developing the family run jewellery business back in the hometown of Bangalore, India. The tasks of maintaining customer relations, customer queries and satisfaction has been the main motivation behind her work. Her main busniess strategies included Marketing, Business Development and creating avenues where customers were interested to visit the business.} % To have no About Me section, just remove all the text and leave \aboutme{}
